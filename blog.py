...
image_1 = st.image("../pages/Blog/pics/fixit1.jpg")
...
image_2 = st.image("../pages/Blog/pics/fixit2.jpg")

st.subheader(":orange[API SELECTION:]")

image_3 = st.image("../pages/Blog/pics/api.jpg")
...
image_4 = st.image("../pages/Blog/pics/fileuploader.jpg")
...
image_5 = st.image("../pages/Blog/pics/reminder.jpg")  
...
image_6 = st.image("../pages/Blog/pics/languages.jpg")
...
image_7 = st.image("../pages/Blog/pics/chathistory.jpg")
